  ...
  items: [
    {
      ...
      created_at: '2013-05-24T16:15:54Z',
      updated_at: '2024-07-14T12:29:48Z',
      pushed_at: '2024-07-13T20:33:48Z',
      ...
      size: 541263,
      stargazers_count: 225265,
      watchers_count: 225265,
      language: 'JavaScript',
      has_issues: true,
      has_projects: true,
      has_downloads: true,
    ...
    },
    {
      ...
      tags_url:
        'https://api.github.com/repos/typescript-cheatsheets/react/tags',
      blobs_url:
      ...
      updated_at: '2024-07-14T12:11:37Z',
      pushed_at: '2024-07-13T10:52:52Z',
      ...
      size: 3177,
      stargazers_count: 44544,
      watchers_count: 44544,
      language: 'JavaScript',
      has_issues: true,
      has_projects: false,
      has_downloads: true,
    ...
    },
    {
      ...
      updated_at: '2024-07-13T15:50:00Z',
    ...
    },
    {
      ...
      owner: {
        ...
        following_url:
          'https://api.github.com/users/primer/following{/other_user}',
        gists_url: 'https://api.github.com/users/primer/gists{/gist_id}',
        starred_url:
          'https://api.github.com/users/primer/starred{/owner}{/repo}',
        ...
        received_events_url:
          'https://api.github.com/users/primer/received_events',
        type: 'Organization',
        site_admin: false,
      },
      ...
      issue_events_url:
        'https://api.github.com/repos/primer/react/issues/events{/number}',
      events_url: 'https://api.github.com/repos/primer/react/events',
      assignees_url:
        'https://api.github.com/repos/primer/react/assignees{/user}',
      branches_url:
        'https://api.github.com/repos/primer/react/branches{/branch}',
      ...
      contributors_url:
        'https://api.github.com/repos/primer/react/contributors',
      subscribers_url: 'https://api.github.com/repos/primer/react/subscribers',
      subscription_url:
        'https://api.github.com/repos/primer/react/subscription',
      commits_url: 'https://api.github.com/repos/primer/react/commits{/sha}',
      git_commits_url:
        'https://api.github.com/repos/primer/react/git/commits{/sha}',
      comments_url:
        'https://api.github.com/repos/primer/react/comments{/number}',
      issue_comment_url:
        'https://api.github.com/repos/primer/react/issues/comments{/number}',
      contents_url:
        'https://api.github.com/repos/primer/react/contents/{+path}',
      compare_url:
        'https://api.github.com/repos/primer/react/compare/{base}...{head}',
      merges_url: 'https://api.github.com/repos/primer/react/merges',
      archive_url:
        'https://api.github.com/repos/primer/react/{archive_format}{/ref}',
      ...
      milestones_url:
        'https://api.github.com/repos/primer/react/milestones{/number}',
      notifications_url:
      ...
      updated_at: '2024-07-13T15:50:00Z',
      pushed_at: '2024-07-12T21:52:51Z',
    ...
    },
    {
      ...
      owner: {
        ...
        gists_url:
          'https://api.github.com/users/HackYourFuture/gists{/gist_id}',
        starred_url:
      ...
      keys_url:
        'https://api.github.com/repos/HackYourFuture/React/keys{/key_id}',
      collaborators_url:
      ...
      updated_at: '2024-07-13T15:50:00Z',
      pushed_at: '2024-06-20T17:34:16Z',
    ...
    },
    {
      ...
      owner: {
        login: 'ysymyth',
        id: 4877252,
        node_id: 'MDQ6VXNlcjQ4NzcyNTI=',
        avatar_url: 'https://avatars.githubusercontent.com/u/4877252?v=4',
        gravatar_id: '',
        url: 'https://api.github.com/users/ysymyth',
        html_url: 'https://github.com/ysymyth',
        followers_url: 'https://api.github.com/users/ysymyth/followers',
        following_url:
          'https://api.github.com/users/ysymyth/following{/other_user}',
        gists_url: 'https://api.github.com/users/ysymyth/gists{/gist_id}',
        starred_url:
          'https://api.github.com/users/ysymyth/starred{/owner}{/repo}',
        subscriptions_url: 'https://api.github.com/users/ysymyth/subscriptions',
        organizations_url: 'https://api.github.com/users/ysymyth/orgs',
        repos_url: 'https://api.github.com/users/ysymyth/repos',
        events_url: 'https://api.github.com/users/ysymyth/events{/privacy}',
        received_events_url:
          'https://api.github.com/users/ysymyth/received_events',
        type: 'User',
        site_admin: false,
      },
      ...
      fork: false,
      url: 'https://api.github.com/repos/ysymyth/ReAct',
      forks_url: 'https://api.github.com/repos/ysymyth/ReAct/forks',
      keys_url: 'https://api.github.com/repos/ysymyth/ReAct/keys{/key_id}',
      collaborators_url:
        'https://api.github.com/repos/ysymyth/ReAct/collaborators{/collaborator}',
      teams_url: 'https://api.github.com/repos/ysymyth/ReAct/teams',
      hooks_url: 'https://api.github.com/repos/ysymyth/ReAct/hooks',
      issue_events_url:
        'https://api.github.com/repos/ysymyth/ReAct/issues/events{/number}',
      events_url: 'https://api.github.com/repos/ysymyth/ReAct/events',
      assignees_url:
        'https://api.github.com/repos/ysymyth/ReAct/assignees{/user}',
      branches_url:
        'https://api.github.com/repos/ysymyth/ReAct/branches{/branch}',
      tags_url: 'https://api.github.com/repos/ysymyth/ReAct/tags',
      blobs_url: 'https://api.github.com/repos/ysymyth/ReAct/git/blobs{/sha}',
      git_tags_url: 'https://api.github.com/repos/ysymyth/ReAct/git/tags{/sha}',
      git_refs_url: 'https://api.github.com/repos/ysymyth/ReAct/git/refs{/sha}',
      trees_url: 'https://api.github.com/repos/ysymyth/ReAct/git/trees{/sha}',
      statuses_url: 'https://api.github.com/repos/ysymyth/ReAct/statuses/{sha}',
      languages_url: 'https://api.github.com/repos/ysymyth/ReAct/languages',
      stargazers_url: 'https://api.github.com/repos/ysymyth/ReAct/stargazers',
      contributors_url:
        'https://api.github.com/repos/ysymyth/ReAct/contributors',
      subscribers_url: 'https://api.github.com/repos/ysymyth/ReAct/subscribers',
      subscription_url:
        'https://api.github.com/repos/ysymyth/ReAct/subscription',
      commits_url: 'https://api.github.com/repos/ysymyth/ReAct/commits{/sha}',
      git_commits_url:
        'https://api.github.com/repos/ysymyth/ReAct/git/commits{/sha}',
      comments_url:
        'https://api.github.com/repos/ysymyth/ReAct/comments{/number}',
      issue_comment_url:
        'https://api.github.com/repos/ysymyth/ReAct/issues/comments{/number}',
      contents_url:
        'https://api.github.com/repos/ysymyth/ReAct/contents/{+path}',
      compare_url:
        'https://api.github.com/repos/ysymyth/ReAct/compare/{base}...{head}',
      merges_url: 'https://api.github.com/repos/ysymyth/ReAct/merges',
      archive_url:
        'https://api.github.com/repos/ysymyth/ReAct/{archive_format}{/ref}',
      downloads_url: 'https://api.github.com/repos/ysymyth/ReAct/downloads',
      issues_url: 'https://api.github.com/repos/ysymyth/ReAct/issues{/number}',
      pulls_url: 'https://api.github.com/repos/ysymyth/ReAct/pulls{/number}',
      milestones_url:
        'https://api.github.com/repos/ysymyth/ReAct/milestones{/number}',
      notifications_url:
        'https://api.github.com/repos/ysymyth/ReAct/notifications{?since,all,participating}',
      labels_url: 'https://api.github.com/repos/ysymyth/ReAct/labels{/name}',
      releases_url: 'https://api.github.com/repos/ysymyth/ReAct/releases{/id}',
      deployments_url: 'https://api.github.com/repos/ysymyth/ReAct/deployments',
      created_at: '2022-11-13T19:51:09Z',
      updated_at: '2024-07-14T05:33:07Z',
      pushed_at: '2024-02-06T02:34:32Z',
      git_url: 'git://github.com/ysymyth/ReAct.git',
      ssh_url: 'git@github.com:ysymyth/ReAct.git',
      clone_url: 'https://github.com/ysymyth/ReAct.git',
      svn_url: 'https://github.com/ysymyth/ReAct',
      homepage: '',
      size: 6459,
    ...
    },
    {
      ...
      updated_at: '2024-07-14T11:22:12Z',
      pushed_at: '2024-07-14T12:25:12Z',
      ...
      size: 1996371,
      stargazers_count: 123140,
      watchers_count: 123140,
      language: 'JavaScript',
      has_issues: true,
      has_projects: false,
      has_downloads: true,
